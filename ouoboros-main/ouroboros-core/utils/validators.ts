...
export class Validators {
  static validateTopology(topology: any): ValidationResult {
    const errors: string[] = [];
  ...
  static validateWeights(weights: number[], expectedLength: number): ValidationResult {
    const errors: string[] = [];
  ...
  static validateSparsity(sparsity: number): ValidationResult {
    const errors: string[] = [];
  ...
  static validateLayerConfig(config: any): ValidationResult {
    const errors: string[] = [];
